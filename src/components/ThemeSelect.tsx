...
export function ThemeSelect() {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        <span
          className="h-5 w-5 rounded-full ring-2 ring-white/40 dark:ring-white/20"
      ...
      {open && (
        <div
          role="listbox"
          className="animate-dropdown glass absolute right-0 z-50 mt-2 w-56 origin-top-right rounded-xl p-2 shadow-2xl"
        >
            ...
            {THEMES.map((th) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {active && <span className="text-white drop-shadow">✓</span>}
                  </span>
                  <span className="max-w-full truncate text-[10px] text-slate-600 dark:text-slate-300">
                    {th.name}
                  </span>
                </button>
              )
